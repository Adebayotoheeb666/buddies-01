export interface CampusLocation {
  id: string;
  name: string;
  location_type: 'building' | 'classroom' | 'cafe' | 'library' | 'gym' | 'parking' | 'dorm' | 'dining';
  description: string;
  latitude: number;
  longitude: number;
  address: string;
...
export const mockCampusLocations: CampusLocation[] = [
  {
    ...
    description: 'Central campus library with extensive resources and study spaces',
    latitude: 40.7128,
    longitude: -74.0060,
  ...
  },
  {
    ...
    description: 'Home to Computer Science, Electrical, and Mechanical Engineering departments',
    latitude: 40.7130,
    longitude: -74.0055,
...
export const mockBuildingRoutes: BuildingRoute[] = [
  {
    ...
    route_description: 'Exit Main Library, turn right, walk 200m to Engineering Building',
    route_coordinates: [
...
export const mockLibraryZones: LibraryZone[] = [
  ...
  },
  {
    ...
    noise_level: 'collaborative',
    equipment_available: ['Whiteboards', 'Group Tables', 'TV Displays', 'Presentation Equipment'],
    floor: 1,
  ...
  },
  {
    ...
    noise_level: 'moderate',
    equipment_available: ['Desktop Computers', 'Laptops for Checkout', '3D Printers', 'VR Equipment'],
    floor: 2,
